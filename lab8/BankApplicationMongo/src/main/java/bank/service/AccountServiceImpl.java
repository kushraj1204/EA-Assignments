...
import bank.repository.AccountRepositoryNSQL;
...
public class AccountServiceImpl implements AccountService {
    private AccountRepositoryNSQL accountRepository;
    private CurrencyConverter currencyConverter;
    private JMSSender jmsSender;
    private Logger logger;

    public AccountServiceImpl(AccountRepositoryNSQL accountRepository, CurrencyConverter currencyConverter, JMSSender jmsSender, Logger logger) {
